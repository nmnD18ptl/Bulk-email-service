...
public interface ContactRepository extends JpaRepository<Contact, Long> {
    ...
    Optional<Contact> findByOrganizationIdAndEmailIgnoreCase(Long organizationId, String email);
    ...
    Page<Contact> findByOrganizationIdAndStatus(Long organizationId, Contact.ContactStatus status, Pageable pageable);
    ...
    long countByOrganizationIdAndStatus(Long organizationId, Contact.ContactStatus status);
